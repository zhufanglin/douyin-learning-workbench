...
export type HistoryTask = { search_mode?: "videos"|"comments"|null; business_profile?: {id:string;name:string;goal:string} | null; id: string; keyword: string; source: string; status: string; note: string; created_at: string; counts: Record<string, number>; videos: SavedVideo[] }
