...
export function ThemeToggle() {
  ...
  return (
    <Select value={theme} onValueChange={(value: Theme) => setTheme(value)}>
      <SelectTrigger aria-label="界面主题" className="w-24 shrink-0 h-8 text-xs border-cyber-border-subtle bg-cyber-bg-tertiary/50 hover:border-cyber-neon-cyan/50 transition-colors">
